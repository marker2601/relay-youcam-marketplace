...
- Duration: 161.600000 seconds (2:41.600)
- File size: 12,381,850 bytes
- SHA-256: `BA1F60AE0C0B9CF13E5A228EDDB9E86560665773CAF5909E665E00064C857ABB`
- Format: 1920x1080, 30 fps, H.264 `yuv420p`, AAC stereo at 48 kHz, with `ftyp` -> `moov` -> `mdat` atom order
- Decode: 4,848 of 4,848 frames decoded with no decoder error
...
- Captions: 36 burned-in caption cues were inspected at their midpoints; captions remained clear of active controls
- Visual/privacy QA: chapter and caption review confirmed readable product proof, the approved ochre/green character treatment, and no visible credentials, task IDs, signed URLs, private keys, local paths, or unrelated browser content
