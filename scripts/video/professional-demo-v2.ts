...
export function buildHumanHandoffAss(input: HumanHandoffAssInput): string {
  ...
  const lines = [
    ...
    dialogue(7, plan.startSeconds + 0.2, plan.endSeconds - 0.2, plan.id, `{\\an7\\move(395,350,850,350,200,850)\\fad(250,400)\\1c${COLORS.gold}\\bord0\\p1}m 0 0 l 440 0 l 440 8 l 0 8`),
    dialogue(7, decline.startSeconds, decline.endSeconds, decline.id, `{\\an7\\move(965,235,965,250,0,250)\\fad(180,450)\\1c${COLORS.red}\\bord2\\3c${COLORS.darkGreen}\\t(0,260,\\fscx106\\fscy106)}PRIMARY DECLINES`),
